...
# result = re.findall("Python",str) /Ayrı ayrı yazar.
# result = len(result) re içerisinde kaç tane string deger var onu karşımıza getirir.
...
# result = re.sub("\s","-",str) #Aradaki boşlukları siler ve aralarına - işareti koyar.

# result = re.search("Python",str)

# result = result.span() #Konumunu buradan alabiliriz.

# result = result.end() #Bitiş numarasını söyler.
